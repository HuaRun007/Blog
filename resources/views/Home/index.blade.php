...
<html>
  <head>
    ...
    <title>华小润的博客 - opqnext.com</title>

    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">

    <meta name="keywords" content="华小润, PHP, 技术博客, PHP框架, 华小润的博客, opqnext, 摇滚青年" />

    <meta name="description" content="华小润的博客 - opqnext.com | 我们都是一段时间的技术小能手。" />
...
<header>
	<a id="logo" href="/" title="华小润的博客 - opqnext.com">
	<img src="./picture/favicon.png" alt="华小润的博客 - opqnext.com"></a>
	...
	<div class="wrapper">
		<div class="layout layout--center">
			<div class="layout__item palm-mb">
				<div class="media">
					<img class="headimg" src='picture/logo.jpg' alt='华小润'>
...
<footer class="footer" role="contentinfo">
	<div class="wrapper wrapper--wide split split--responsive">
		<span>Theme by <a href="http://github.com/yumemor">Yumemor</a>. Powered by <a href="http://hexo.io">Hexo</a> | &copy 2017 华小润</span>
	</div>
</footer>
...
<script type="text/javascript" color="105,205,255" opacity="0.7" zindex="-2" count="300" src="./js/canvas-nest.js"></script><canvas id="c_n3" width="1920" height="949" style="position: fixed; top: 0px; left: 0px; z-index: -2; opacity: 0.7;"></canvas>
<script>
...
//            console.log(banner.length,index);
            bannerNode.attr('style','background-image:url(http://web.blog.com/banner/'+banner[index]+'.jpg)');
